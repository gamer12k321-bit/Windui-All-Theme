...
v=getValue(r,p.Themes.Cotton Candy)
if v~=nil then
if typeof(v)=="string"and string.sub(v,1,1)~="#"then
local z=p.GetThemeProperty(v,p.Themes.Cotton Candy)
if z~=nil then
return z
end
else
...
if x~=nil then
if typeof(x)=="string"and string.sub(x,1,1)~="#"then
return p.GetThemeProperty(x,p.Themes.Cotton Candy)
else
return getValue(r,{[r]=x})
end
end
...
local aB=aa.Themes[ay.Theme or"Cotton Candy"]
